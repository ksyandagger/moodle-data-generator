                    ...
                    for ($j = 0; $j < $settings['number-of-modules']; $j++) {
                        ...
                        switch ($moduledata->name) {
                            case 'assignment':
                                ...
                                $module->assignmenttype = $assignment_types[array_rand($assignment_types)];
                            ...
                            case 'forum':
                                $module->intro = $description;
                                $module->type = $forum_types[array_rand($forum_types)];
                                $module->forcesubscribe = rand(0, 1);
                                break;
                            case 'glossary':
                                $module->intro = $description;
                                $module->displayformat = $glossary_formats[array_rand($glossary_formats)];
